...
1) Java has ; at the end of their lines
2) Their usage of public static void in their classes
3) all variables must state their variable types
4) for loops require you to set your starting value and how much it increases per loop
5) and function is &&
